#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════════════
#  build_mac.sh  —  Builds pi-dashboard-mac.dmg
...
#
#  Output:  dist/pi-dashboard-mac.dmg
# ═══════════════════════════════════════════════════════════════════════════
set -e

VERSION="10.0"
APP_NAME="Pi Dashboard"
BUNDLE_ID="com.pidashboard.app"
DMG_NAME="pi-dashboard-mac.dmg"

echo
echo "───────────────────────────────────────────────────────────"
echo "  Pi Dashboard — macOS .dmg Build"
...
TEMP_DMG="dist/pi-dashboard-temp.dmg"
hdiutil create \
    -volname "${APP_NAME}" \
    -srcfolder "${DMG_STAGE}" \
    -ov \
